...
EUR/USD, GBP/USD, USD/JPY *(and others depending on session)*

##  Features

- Session-based pair activation (London, New York, Asian sessions)
- 100+ automated operations/month
- Risk management integrated (SL/TP per trade)
